...
#define DEFAULT_STORAGE_PATH "/esp32cam"
#define DEFAULT_VIDEO_ENABLED false
#define DEFAULT_VIDEO_DURATION 60000
#define DEFAULT_VIDEO_MAX_SIZE 0
#define DEFAULT_SNAPSHOT_COUNT 0